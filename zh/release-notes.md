...
* 예를 들어, 다음과 같은 주소 범위를 갖는 세 VPC에 대해, 
	...
	VPC1과 VPC2를 피어링 한 상태에서 VPC1과 VPC3을 피어링 할 수 없습니다. 이러한 피어링을 허용할 경우, VPC2와 VPC3의 주소범위가 중첩되기 때문에 
	VPC1에 위치한 인스턴스에서 VPC2(172.16.0.0/16) 대역으로 패킷을 발신하면 VPC2가 아닌 VPC3으로 라우팅 될 수 있습니다.
